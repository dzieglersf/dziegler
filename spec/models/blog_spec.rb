...
describe Blog do
	...
	describe "entries" do
		...
		it "is sorted in reverse chronological order" do
			oldest = stub_entry_with_date("2012-01-01")
			newest = stub_entry_with_date("2012-01-03")
			middle = stub_entry_with_date("2012-01-02")
			@it.add_entry oldest
			@it.add_entry newest
			@it.add_entry middle
		...
		it "is limited to 10 items" do 
			10.times do |i|
				@it.add_entry(stub_entry_with_date("2012-12-#{i+1}"))
			end
			oldest = stub_entry_with_date("2012-01-31")
			@it.add_entry oldest
