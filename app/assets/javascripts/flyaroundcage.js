...
var paper = Raphael(0, 0, window_width, $(window).height());

//BACKGROUND
var sky = paper.rect(0,0,window_width, $(window).height());
...
var space_between_horizontal_bars = $(window).height() / NUMBER_OF_HORIZONTAL_BARS;
var BAR_THICKNESS = 4;
var BAR_COLOR = "#FFD700"

for (i=0; i<NUMBER_OF_VERTICAL_BARS; i++) {
	var bar = paper.rect(i*space_between_vertical_bars, 0, BAR_THICKNESS, $(window).height());
